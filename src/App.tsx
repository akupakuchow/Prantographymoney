             ...
             <div className="mb-14 text-[14px] text-[#222]">
                ...
                <div className="flex items-center w-max relative group">
                   ...
                   <div className="relative flex items-center">
                      <Input value={date} onChangeValue={setDate} className="font-medium min-w-[120px] placeholder-gray-400 z-10" placeholder="DD.MM.YYYY" />
                      {/* Calendar button next to it */}
                      <div className="relative w-5 h-5 ml-1 opacity-40 hover:opacity-100 cursor-pointer no-print overflow-hidden rounded flex items-center justify-center">
                         <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="pointer-events-none"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>
                         <input 
                            type="date"
